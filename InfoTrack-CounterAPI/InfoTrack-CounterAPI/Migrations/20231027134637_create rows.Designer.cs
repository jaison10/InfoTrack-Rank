...
namespace InfoTrack_CounterAPI.Migrations
{
    ...
    [Migration("20231027134637_create rows")]
    partial class createrows
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InfoTrack_CounterAPI.Models.Domain.SearchEngine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2c409c7c-6a91-4a73-806a-3bb48d38e319"),
                            EngineName = "Bing",
                        ...
                        new
                        {
                            Id = new Guid("ae410443-42d5-4d73-966a-07afc573c338"),
                            EngineName = "Google",
